"""Reports API blueprint — SQL query and report endpoints."""
...
from artemis.utils.validation import validate_ip, validate_target
from artemis.utils.dns import ScanError, resolve_ip_param
from artemis.services.report_service import (
    generate_report, generate_report_from_existing, generate_report_plot
)
